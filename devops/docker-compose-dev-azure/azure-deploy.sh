...
resourcename="petshopmanagementsystem"  # lower case, only
resourcegroup="petshopmanagementsystem_rg"
...
# git clone https://github.com/apilogicserver/petshopmanagementsystem.git
# cd petshopmanagementsystem
...
az group create --name petshopmanagementsystem_rg --location "westus"
az appservice plan create --name myAppServicePlan --resource-group petshopmanagementsystem_rg --sku S1 --is-linux
az container create --resource-group petshopmanagementsystem_rg --name petshopmanagementsystem --image apilogicserver/petshopmanagementsystem:latest --dns-name-label petshopmanagementsystem --ports 5656 --environment-variables 'VERBOSE'='True'  'APILOGICPROJECT_CLIENT_URI'='//petshopmanagementsystem.westus.azurecontainer.io:5656'
